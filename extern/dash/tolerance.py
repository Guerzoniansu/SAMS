...
# tolerances for crops


temperature_tolerance = {
    "whea": {
        "germination": {"min": 3, "max": 35},
        "vegetative": {"min": 5, "max": 30},
        "flowering": {"min": 15, "max": 25},
        "maturity": {"min": 10, "max": 25},
    },
    "rice": {
        "germination": {"min": 10, "max": 40},
        "vegetative": {"min": 20, "max": 35},
        "flowering": {"min": 25, "max": 30},
        "maturity": {"min": 15, "max": 30},
    },
    "maiz": {
        "germination": {"min": 8, "max": 40},
        "vegetative": {"min": 18, "max": 35},
    ...
    "smil": {
        ...
        "vegetative": {"min": 20, "max": 32},
        "flowering": {"min": 22, "max": 30},
        "maturity": {"min": 15, "max": 30},
    },
    "sorg": {
        "germination": {"min": 15, "max": 40},
    ...
    "pota": {
        "germination": {"min": 7, "max": 30},
        "vegetative": {"min": 10, "max": 25},
        "flowering": {"min": 15, "max": 25},
        "maturity": {"min": 10, "max": 25},
    },
    "swpo": {
        "germination": {"min": 18, "max": 40},
        "vegetative": {"min": 20, "max": 35},
        "flowering": {"min": 25, "max": 30},
        "maturity": {"min": 20, "max": 30},
    },
